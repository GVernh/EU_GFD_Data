...
setwd("D:/Europe_study_data/SPlot/R code for spatial biodiv/meth/")
...
traits <- read.csv("D:/Europe_study_data/SPlot/Complete_biodiversity_data/Selected_trait_data.csv")
...
save(results,file="results_1m_plots.Rdata")
...
# save(results,file="results_all_plots.Rdata")
...
write.csv(results, "./results_FunD_1m_plots.csv", row.names = F)
# write.csv(results, "./results_FunD_100m_plots.csv", row.names = F)
# write.csv(results, "./FD_results/results_FD.csv", row.names = F)                ############################
...
#results1 = read.csv("D:/Europe_study_data/SPlot/Complete_biodiversity_data/100m_plots_only/results_FunD_100m_plots.csv")
#load(file="./results_100m_plots.Rdata")
#results2 = as.data.frame(results)
                                                                                   ##############################
#results1 = read.csv("D:/Europe_study_data/SPlot/Complete_biodiversity_data/400m_plots_only/results_FunD_400m_plots.csv")
#load(file="./results_400m_plots.Rdata")
#results2 = as.data.frame(results)

# results1 = read.csv("D:/Europe_study_data/SPlot/Complete_biodiversity_data/FD_results/results_FD.csv")
# load(file="./FD_results/results_all_plots.Rdata")
# results2 = as.data.frame(results)

#results1 = read.csv("D:/Europe_study_data/SPlot/Complete_biodiversity_data/1km_plots_only/results_FunD_1km_plots.csv")
#load(file="./results_1km_plots.Rdata")
#results2 = as.data.frame(results)

results1 = read.csv("./results_FunD_1m_plots.csv")
load(file="./results_1m_plots.Rdata")
results2 = as.data.frame(results)
...
write.csv(results, "./results_Full_1m_plots.csv", row.names = F)
...
# write.csv(results, "./FD_results/results_Full.csv", row.names = F)