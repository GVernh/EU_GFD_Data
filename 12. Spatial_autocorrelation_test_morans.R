...
source("./Functions/lavSpatialCorrect.R")
source("./Functions/predict_lavaan.R")
...
dir.create("./Analysis/Finalised_dataset/Spatially_corrected_data", showWarnings = FALSE)
# -------------- 100m plot test -----------------
...
write.csv(Trait_coefs_100, file = "./Analysis/Finalised_dataset/Spatially_corrected_data/FD_coefs_100m_spatially_corrected.csv", 
          row.names = F)
...
write.csv(Trait_coefs_400, file = "./Analysis/Finalised_dataset/Spatially_corrected_data/FD_coefs_400m_spatially_corrected.csv", 
          row.names = F)
...
write.csv(Trait_coefs_1000, file = "./Analysis/Finalised_dataset/Spatially_corrected_data/FD_coefs_1000m_spatially_corrected.csv", 
          row.names = F)