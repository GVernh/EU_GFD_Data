...
data_1000 = read.csv("D:/Europe_study_data/Analysis/Finalised_dataset/Transformed/Full_dataset_1000m_trans.csv")
  ...
  " # Regressions
       ...
       # Derived quantities
          # Topography
            ...
            Top_via_N := TN*NR
            Top_via_CeC := TCe*CeR
            Top_via_silt := TSi*SiR
            Top_total_indirect := TSC*SCR + TS*SR + TC*CR + TTW*TWR + TN*NR + TCe*CeR + TSi*SiR
