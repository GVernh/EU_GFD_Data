...
#---------------------- DATA --------------------------------------=----
setwd("\Europe_study_Git\Data_prep\Biodiversity_data")
...
#----------------------------- KEW CHECKLIST -----------------------------
sp_checklist = read.table("Europe_study_Git\Data_prep\Biodiversity_data\wcvp_names.txt", sep="|", header=TRUE, quote = "", fill=TRUE, encoding = "UTF-8") 
dist_checklist = read.table("Europe_study_Git\Data_prep\Biodiversity_data\wcvp_distribution.txt", sep="|", header=TRUE, quote = "", fill=TRUE, encoding = "UTF-8")
...
# setwd("./100m_plots_only/")
# setwd("./400m_plots_only/")
# setwd("./1km_plots_only/")     #############################
