data_100 = read.csv("/Europe_study_Git/Analyses/Finalised_datasets/Full_dataset_100m_plots_transformed.csv")
  ...
  " # Regressions
       ...
       # Derived quantities
          # Topography
            ...
            Temp_total_indirect := ATSC*SCR + ATP*PR + ATC*CR + ATCe*CeR
