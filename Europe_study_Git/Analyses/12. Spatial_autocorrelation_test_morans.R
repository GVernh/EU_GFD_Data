...
write.csv(Trait_coefs_100, file = "./Spatially_corrected_data/FD_coefs_100m_spatially_corrected.csv", 
          row.names = F)
...
write.csv(Trait_coefs_400, file = "./FD_coefs_400m_spatially_corrected.csv", 
          row.names = F)
...
write.csv(Trait_coefs_1000, file = "./FD_coefs_1000m_spatially_corrected.csv", 
          row.names = F)